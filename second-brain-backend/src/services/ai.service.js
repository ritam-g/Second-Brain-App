 ...
 * @param {Object} [context={}] - Optional metadata such as file name, file type, and fallback values.
 * @returns {Promise<Object>} Object containing `title`, `description`, and normalized `tags`.
 */
 ...
 * @param {Object[]} [options.sources=[]] - Ordered list of retrieved chunk-like objects.
 * @returns {Promise<string>} Concise answer text generated by Mistral.
 */
