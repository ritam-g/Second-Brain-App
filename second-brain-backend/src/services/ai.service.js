...
/**
 * Analyzes extracted text to generate professional titles, summaries, and normalized tags.
 * Uses Mistral AI to distill noisy OCR data into clean, structured metadata.
 */
 ...
 * 
 * @async
 * @param {string} text - Extracted text string.
 * @param {Object} [context={}] - Optional metadata such as file name and file type.
 * @returns {Promise<string[]>} Normalized array of tags ready to store in MongoDB.
 */
...
/**
 * Summarizes context from source chunks to provide a direct answer to user queries.
 * Ensures the response is grounded only in the provided documents to prevent hallucination.
 */
 ...
 * @param {string} [options.url=""] - Instagram URL.
 * @param {string} [options.title=""] - Scraped title.
 * @param {string} [options.imageUrl=""] - Preview image URL.
 * @returns {Promise<string>} Short description string.
 */
 ...
 * @param {string} [options.transcriptText=""] - Optional transcript text.
 * @returns {Promise<string>} Concise English description string.
 */
...
/**
 * Lazily creates the Mistral chat model.
 * 
 * @returns {ChatMistralAI} Configured ChatMistralAI instance.
 * @throws {Error} If MISTRAL_API_KEY is not configured.
 */
...
/**
 * Builds a compact metadata prompt for the AI.
 * 
 * @param {string} text - Extracted text string.
 * @param {Object} context - Metadata object.
 * @returns {string} Prompt string to send to the chat model.
 */
 ...
 * @param {Object[]} sources - Normalized retrieval source list.
 * @returns {string} Prompt string ready for Mistral.
 */
...
/**
 * Clips retrieved sources into a prompt-safe structure.
 * 
 * @param {Object[]} sources - Raw retrieval source list.
 * @returns {Object[]} Normalized source list.
 */
 ...
 * 
 * @param {string|Object[]} content - LangChain response content.
...
/**
 * Parses the Mistral response into a metadata object.
 * 
 * @param {string} content - Model response text.
 * @returns {Object} Plain object with title, description, and tags.
 */
...
/**
 * Safely parses JSON text into an array of strings.
 * 
...
/**
 * Safely parses JSON text into a plain object.
 * 
 * @param {string} value - JSON string.
...
/**
 * Builds deterministic fallback tags.
 * 
 * @param {string} text - Extracted text string.
 * @param {Object} context - Metadata object.
 * @returns {string[]} Normalized array of fallback tags.
 */
...
/**
 * Merges AI tags with fallback tags.
 * 
 * @param {string[]} aiTags - AI-generated tags.
 * @param {string[]} fallbackTags - Fallback tags.
 * @returns {string[]} Deduplicated tag array capped at 10.
 */
 ...
 * 
 * @param {string[]} tags - Array of raw tag strings.
 * @returns {string[]} Lowercase, deduplicated tags.
 */
...
/**
 * Extracts meaningful keywords without relying on AI.
 * 
 * @param {string} value - Free-form text value.
...
/**
 * Sanitizes a single tag for MongoDB.
 * 
 * @param {string} tag - Raw tag string.
 * @returns {string} Cleaned lowercase tag.
 */
...
/**
 * Normalizes short AI-generated text fields.
 * 
 * @param {string} value - Raw AI-generated string.
 * @param {number} maxLength - Maximum character length.
 * @returns {string} Cleaned string clipped to size.
 */
